				...
				<div class="row">
			        ...
			        while( $row = sqlsrv_fetch_array($result, SQLSRV_FETCH_ASSOC) ) {
								...
								if ($row['status'] == "NYE SAKER") {
									$saker_undertekst = "TILDELT ".$avdelinger['Lyngdal']." OG OPPRETTET ".$valgt_periode."";
								}elseif ($row['status'] == "ÅPNE SAKER") {
									$saker_undertekst = "TILDELT ".$avdelinger['Lyngdal']."";
								}elseif ($row['status'] == "LØSTE SAKER") {
									$saker_undertekst = "TILDELT ".$avdelinger['Lyngdal']." OG LØST ".$valgt_periode."";
								}else {
