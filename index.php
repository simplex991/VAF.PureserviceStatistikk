...
<head>
	...
	<title>S-PS - Alle Avdelinger</title>
...
<body>
  ...
  include 'array-variabler.php';
    ...
    $topp_saker = "SELECT TOP 10 r.RequestNumber, r.Subject, u.FirstName, u.LastName, r.Created
                   from Requests r
    ...
    $topp_saker_result = sqlsrv_query($connect, $topp_saker);
  ...
  ?>
	<header class="cd-main-header">
      ...
      <ul class="cd-top-nav">
         <li><a href="https://pureservice.vaf.no" target="_blank">PureService</a></li>
				 <li><a href="test.side.php" target="_blank">Test side</a></li>
	...
	<main class="cd-main-content">
		...
		<div class="content-wrapper">
			<div class="container-fluid">
				...
				<div class="row">
			        ...
			        while( $row = sqlsrv_fetch_array($result, SQLSRV_FETCH_ASSOC) ) {
								$saker_undertekst = ""; // Declare variable

								if ($row['status'] == "NYE SAKER") {
									$saker_undertekst = "TILDELT ".$avdelinger['Alle']." OG OPPRETTET ".$valgt_periode."";
								}elseif ($row['status'] == "ÅPNE SAKER") {
									$saker_undertekst = "TILDELT ".$avdelinger['Alle']."";
								}elseif ($row['status'] == "LØSTE SAKER") {
									$saker_undertekst = "TILDELT ".$avdelinger['Alle']." OG LØST ".$valgt_periode."";
								}else {
									$saker_undertekst = "Teksten lastet ikke, noe gikk feil";
								}
								echo "<div class='saker col-md-3' style='margin: 0 7px 7px 0; background-color:#fff; padding: 10px;'>";
					...
					<div class="row">
						<div class="gjen col-md-3" style="margin: 0 7px 7px 0; background-color:#fff; padding: 10px;">
            ...
            <div class='lengst col-md-6' style='margin: 0 7px 7px 0; background-color:#fff; padding: 10px;'>
            <h2 style='color:#595959;' class='text-center'><b> ÅPNE SAKER MED LENGST VENTETID </b></h2>
            <?php $topp_saker_undertekst = "TOPP 10 SOM ER TILDELT ".$avdelinger['Alle']." SORTERT PÅ LENGST VENTETID"; ?>
            <h5 class='subtitle text-center' style='color:#a6a6a6;'><small><b> <?php echo $topp_saker_undertekst; ?></b></small></h5>
            <table>
              <tr>
                <th>ID</th>
                <th>Emne</th>
            ...
            <?php
              while( $row_topp = sqlsrv_fetch_array($topp_saker_result, SQLSRV_FETCH_ASSOC) ) {
                echo "<tr>";
                echo "<td>" . $row_topp["RequestNumber"] . "</td>";
                echo "<td>" . $row_topp["Subject"] . "</td>";
                echo "<td>" . $row_topp["FirstName"] . " " . $row_topp["LastName"] . "</td>";
                echo "<td>" . $row_topp["r.Created"] . "</td>";
                echo "</tr>";
              }
